...
export default class TaskView {
  static displayTask(task, localStorage) {
    ...
    <div>
      ...
      <div class="footer">
      <button class="modify" style="color: ${chooseTextColor(task.codeColor)}">Modifier</button>
      <button class="detail" style="color: ${chooseTextColor(task.codeColor)}">Détails</button>
      </div>
      `;
